...
long startTime= System.currentTimeMillis();
        ...
        Schedule timetable = initializeTT();
        ...
        // Evaluate population
        ga.evalPopulation(population, timetable); //evaluates indiv fitness and calculates total fitness
        ...
        int classIndex = 1;
         ...
         System.out.println("Solution found in Generation Number: " + generation );
         System.out.println("Final Fitness Value for Generation "+ generation +" : " + population.getFittest(0).getFitness());
        ...
        File f = new File("/Users/Aparna/Documents/researchwork/ttga_e_tf1tf3.csv");
        if(f.exists())
        {
        	f.delete();
        	}
    	...
    	fileWriter = new FileWriter("/Users/Aparna/Documents/researchwork/ttga_e_tf1tf3.csv");
        ...
        File f2 = new File("/Users/Aparna/Documents/researchwork/ttga_e_tf2gf2.csv");
        if(f2.exists())
        {
        	f2.delete();
        	}
    	...
    	fw2 = new FileWriter("/Users/Aparna/Documents/researchwork/ttga_e_tf2gf2.csv");
...
FileWriter fw3 = null;
        ...
        File f3 = new File("/Users/Aparna/Documents/researchwork/ttga_e_tf3tf3.csv");
        if(f3.exists())
        {
        	f3.delete();
        	}
        ...
        fw3 = new FileWriter("/Users/Aparna/Documents/researchwork/ttga_e_tf3tf3.csv");
	...
	private static Schedule initializeTT() {
		// Create timetable
